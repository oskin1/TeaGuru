...
class SignupView(PasswordMixin, FormView):
    ...
    messages = {
        "email_confirmation_sent": {
            "level": messages.INFO,
            "text": _("Письмо с подтверждением выслано на {email}.")
        },
        "invalid_signup_code": {
            "level": messages.WARNING,
            "text": _("Код {code} неверен.")
        }
    }
...
class ConfirmEmailView(TemplateResponseMixin, View):
    ...
    messages = {
        "email_confirmed": {
            "level": messages.SUCCESS,
            "text": _("Вы подтвердили адрес эл. почты {email}.")
        }
    }
...
class SettingsView(LoginRequiredMixin, FormView):
    ...
    messages = {
        "settings_updated": {
            "level": messages.SUCCESS,
            "text": _("Настройки аккаунта обновлены.")
        },
    }
...
class DeleteView(LogoutView):
    ...
    messages = {
        "account_deleted": {
            "level": messages.WARNING,
            "text": _("Ваш аккаунт теперь деактивирован, все ваши данные будут удалены через {expunge_hours} часов.")
        },
    }
