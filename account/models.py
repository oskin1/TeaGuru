...
from teaguru.settings import TIME_ZONE, LANGUAGE_CODE
...
class Account(models.Model):
    ...
    type = models.CharField(verbose_name="Тип аккаунта", max_length=1, choices=ACC_TYPES, default="x")
    
    timezone = TimeZoneField(_("timezone"), default=TIME_ZONE)
